...
RStudio is available in open source and commercial editions and runs on the desktop (Windows, Mac, and Linux). <sup>*</sup>
...
.footnote[
[*] From [RStudio](https://posit.co/products/open-source/rstudio/)
]
